...
- **AI Quiz Generator**  
  Create interactive quiz questions from any text to test understanding.

- **Study Dashboard**  
  Manage and review saved flashcards and quizzes in one workspace.

- **User Authentication**  
  Secure login to track personal study content.
